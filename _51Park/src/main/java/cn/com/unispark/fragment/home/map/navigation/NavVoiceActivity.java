 ...
 * </pre>
 */
public class NavVoiceActivity extends BaseActivity implements AMapNaviListener,
		AMapNaviViewListener {

	// 导航栏标题 //返回按钮// 导航栏右侧详情按钮
	...
	public void initView() {
		 ...
		 * moreText.setVisibility(View.VISIBLE); moreText.setText("详情");
		 ...
		 * 初始化语音模块
		 */
		ttsManager = NavVoiceTTSController.getInstance(NavVoiceActivity.this);
		ttsManager.init();

		AMapNavi.getInstance(NavVoiceActivity.this).setAMapNaviListener(
				ttsManager);// 设置语音模块播报
	...
	public void onCalculateRouteSuccess() {
		...
		// naviPath.getAllTime()返回单位为米
		String allLength;
		if (naviPath.getAllLength() > 1000) {
			DecimalFormat formatter = new DecimalFormat("###,##0.00");
			allLength = formatter.format((double)naviPath.getAllLength() / 1000 ) + "千米";
		} else {
			allLength = naviPath.getAllLength() + "米";
		}
