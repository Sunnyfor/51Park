 ...
 *
 */
public class NavVoiceTTSController implements SynthesizerListener, AMapNaviListener {

	public static NavVoiceTTSController ttsManager;
	private Context mContext;
	// 合成对象.
	private SpeechSynthesizer mSpeechSynthesizer;

	NavVoiceTTSController(Context context) {
		mContext = context;
	}

	public static NavVoiceTTSController getInstance(Context context) {
		if (ttsManager == null) {
			ttsManager = new NavVoiceTTSController(context);
		}
		return ttsManager;
	}
