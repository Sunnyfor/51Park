...
public class MobileSecurePayer {
    ...
    public boolean pay(String strOrderInfo, final Handler callback,
        ...
        return pay(strOrderInfo, callback, myWhat, activity, false, false, isTest);
    ...
    public boolean paySign(String strOrderInfo, final Handler callback,
        ...
        return pay(strOrderInfo, callback, myWhat, activity, true, false, isTest);
    ...
    public boolean payAuth(String strOrderInfo, final Handler callback,
        ...
        return pay(strOrderInfo, callback, myWhat, activity, false, true, isTest);
     ...
     * @param isAuthPay 是否是认证支付
     * @param isTest 是否是测试环境，true为测试环境，但不推荐使用。
     * @return
     */
    public boolean pay(String strOrderInfo, final Handler callback,
            final int myWhat, final Activity activity, boolean signCard, boolean isAuthPay, boolean isTest
            ) {
        if (mbPaying)
            return false;
        mbPaying = true;
        ...
        try {
            ...
            if (isAuthPay) {
                strOrderInfo = new JSONObject(strOrderInfo).put("authpay_mode", "1").toString();
            }
