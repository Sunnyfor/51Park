...
public class MultiPartStack extends HurlStack {
	...
	public HttpResponse performRequest(Request<?> request,
		...
		if (!(request instanceof MultiPartJson)) {
	...
	private static void setMultiPartBody(
		...
		Map<String, File> fileUpload = ((MultiPartJson) request)
				.getFileUploads();
		...
		Map<String, String> stringUpload = ((MultiPartJson) request)
				.getStringUploads();
		if (stringUpload != null && !stringUpload.isEmpty()) {
			for (Entry<String, String> entry : stringUpload.entrySet()) {
				// try {
				// jsonObject.put(entry.getKey(), entry.getValue());
				Log.e("slx", "entry=====.getValue()" + entry.getValue());
